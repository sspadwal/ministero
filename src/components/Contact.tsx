...
export const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Phone Numbers",
      details: ["+91 8657448665 "],
    },
    {
      icon: Mail,
      title: "Email Addresses",
      details: ["puneet@ministerosteel.com ", "ministerosteel@gmail.com", ,],
    },
    {
      icon: Clock,
      title: "Working Hours",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Ready to discuss your steel engineering requirements? Our
            experienced team is here to provide expert consultation and
            competitive solutions for your projects.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-6">
            {contactInfo.map((info, index) => (
              <Card
                key={index}
                className="p-6 hover:shadow-steel transition-all duration-300"
              >
                <CardContent className="p-0">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {offices.map((office, index) => (
              <Card
                key={index}
                className="p-6 hover:shadow-steel transition-all duration-300 hover:-translate-y-1"
              >
                <CardContent className="p-0">
        ...
        <div className="bg-background rounded-2xl p-8 text-center shadow-steel">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto leading-relaxed">
            With our network of regional offices and international partnerships,
            we provide comprehensive steel engineering solutions across 25+
            countries worldwide.
          </p>
